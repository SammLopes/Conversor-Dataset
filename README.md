...
```
## EFFResNet-ViT – Guia de Uso

Modelo de classificação de imagens baseado em **EfficientNetB0 + ResNet50 + Transformer (ViT-like)**, implementado em **Keras/TensorFlow**, com treino e avaliação via terminal.

---

## 1. Comandos de uso no terminal

Execute os comandos a partir da pasta onde está o arquivo `effresnet_vit.py`.
